			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-6">
								<a href="#" class="btn" id="login-form-link">Register als werkzoekende</a>
							</div>
							<div class="col-xs-6">
								<a class="btn" href="#" id="register-form-link">Register als werkgever</a>
							</div>
						</div>
						<hr>
					</div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-sm-6 col-sm-offset-3">
                                                    <input type="submit" name="register-submit-wz" id="register-submit" tabindex="4" class="form-control btn" value="Registreer nu!">
                                                </div>
                                            </div>
                                        </div>
                                    </form>
